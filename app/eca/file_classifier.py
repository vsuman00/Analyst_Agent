...
def classify_file(file_path_str: str, extension: str) -> tuple[str, float]:
    ...
    # 1. Entry Point
    entry_points = {
        "main.py", "app.js", "index.js", "app.ts", "index.ts", 
        "app.vue", "main.go", "application.java", "manage.py", 
        "app.py", "main.java", "program.cs"
    }
    ...
    config_exts = {
        ...
        ".cfg", ".xml", ".gradle", ".properties", ".conf"
    }
    ...
    if ext in {".jsx", ".tsx", ".vue", ".svelte", ".html", ".css", ".scss", ".less"}:
